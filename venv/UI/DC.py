...
class DC(Element):
    ...
    def init_view(self):
       self.inputsID.append(self.create_text(self.start_text, 38, text=self.inputs[0]))
       self.inputsID.append(self.create_text(self.start_text, 80, text=self.inputs[1]))
